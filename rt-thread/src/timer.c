...
static void _rt_timer_init(rt_timer_t timer, void (*timeout)(void *parameter), void *parameter, rt_tick_t time,
        rt_uint8_t flag)
{
    int i;
...
static rt_tick_t rt_timer_list_next_timeout(rt_list_t timer_list[])
{
    ...
    {
        timer = rt_list_entry(timer_list[RT_TIMER_SKIP_LIST_LEVEL - 1].next, struct rt_timer,
...
void rt_timer_check(void)
{
    ...
    {
        t = rt_list_entry(rt_timer_list[RT_TIMER_SKIP_LIST_LEVEL - 1].next, struct rt_timer,
                row[RT_TIMER_SKIP_LIST_LEVEL - 1]);
...
void rt_soft_timer_check(void)
{
    ...
    {
        t = rt_list_entry(rt_soft_timer_list[RT_TIMER_SKIP_LIST_LEVEL - 1].next, struct rt_timer,
                row[RT_TIMER_SKIP_LIST_LEVEL - 1]);
...
void rt_system_timer_thread_init(void)
{
    ...
    rt_thread_init(&timer_thread, "timer", rt_thread_timer_entry,
    RT_NULL, &timer_thread_stack[0], sizeof(timer_thread_stack), RT_TIMER_THREAD_PRIO, 10);
